 ...
 * @author zc
 */
public class PlantIssuePropertyChangeAdapter implements PropertyChangeListener {

    private final ListView<Gvent> gventListView;
    private final Button editGventButton;
    private final Button removeGventButton;

    PlantIssuePropertyChangeAdapter(ListView<Gvent> gventListView, Button editGventButton, Button removeGventButton) {
