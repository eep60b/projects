...
public class EditPlantsIssueEventHandler implements EventHandler<ActionEvent> {
    ...
    public EditPlantsIssueEventHandler(AddPlantDataModel model, ListView<GrowingIssue> listView) {
        this.model = model;
    ...
    public void handle(ActionEvent event) {
        ...
        GrowingIssue issure = model.getSelectedGrowingIssueValueWrapper().getValue();
