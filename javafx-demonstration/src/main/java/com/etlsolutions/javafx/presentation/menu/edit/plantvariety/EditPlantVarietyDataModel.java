...
public class EditPlantVarietyDataModel extends DataUnitFXMLDataModel<PlantVariety> {
    ...
    @Override
    public void save() {
        parentModel.addVariety(PlantsFactory.getInstance().createPlantVariety(getTitleValueWrapper(), getLatinName(), getInformationValueWrapper(), getAliases(), getImageLinks()));
    }
