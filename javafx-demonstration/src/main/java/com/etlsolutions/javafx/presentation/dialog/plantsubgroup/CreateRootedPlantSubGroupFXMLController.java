 ...
 * @author zc
 */
public class CreateRootedPlantSubGroupFXMLController extends DataUnitFXMLController<PlantSubGroup, CreateRootedPlantSubGroupDataModel> {
    ...
    @FXML
    private ComboBox<PlantGroup> plantGroupComboBox;
    ...
    public void initializeComponents() {
        ...
        plantGroupComboBox.setItems(model.getPlantGroups());
        plantGroupComboBox.getSelectionModel().select(model.getSelectedPlantGroupValueWrapper().getValue());
        plantGroupComboBox.getSelectionModel().selectedItemProperty().addListener(new ValueChangeAdapter<>(model.getSelectedPlantGroupValueWrapper()));
