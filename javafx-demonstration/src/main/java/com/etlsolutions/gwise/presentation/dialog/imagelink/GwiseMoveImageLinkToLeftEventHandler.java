 ...
 * @author zc
 */
public class GwiseMoveImageLinkToLeftEventHandler implements EventHandler<ActionEvent> {

    private final GwiseDataUnitFXMLDataModel model;

    public GwiseMoveImageLinkToLeftEventHandler(GwiseDataUnitFXMLDataModel model) {
        this.model = model;
    }
