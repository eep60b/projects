...
public class ShapeUtils {
    ...
    public GwiseShape getShape(GwiseShapeBean bean) {
        if (bean instanceof GwiseCircleBean) {
            return new GwiseCircle((GwiseCircleBean) bean);
        } else if (bean instanceof GwiseSquareBean) {
            return new GwiseSquare((GwiseSquareBean) bean);
        } else if (bean instanceof GwiseRectangleBean) {
            return new GwiseRectangle((GwiseRectangleBean)bean);
        } else if (bean instanceof GwiseTriangleBean) {
            return new GwiseTriangle((GwiseTriangleBean)bean);
        } else if (bean instanceof GwisePolygonBean) {
            return new GwisePolygon((GwisePolygonBean)bean);
        } else {
            throw new IllegalStateException("Invalid shape type.");
        }
    }
    
    public GwiseLineShape getShape(GwiseLineShapeBean bean) {
        if (bean instanceof GwiseCircleBean) {
            return new GwiseCircleLine((GwiseCircleLineBean) bean);
        } else if (bean instanceof GwiseLineBean) {
            return new GwiseLine((GwiseLineBean) bean);
        } else if (bean instanceof GwiseArcLineBean) {
            return new GwiseArcLine((GwiseArcLineBean)bean);
        } else if (bean instanceof GwisePolylineBean) {
            return new GwisePolyline((GwisePolylineBean)bean);
        } else {
            throw new IllegalStateException("Invalid shape type.");
        }
    }    
