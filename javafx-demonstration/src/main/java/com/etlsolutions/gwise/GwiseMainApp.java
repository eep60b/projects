 ...
 * @author zc
 */
public class GwiseMainApp extends Application {
    ...
    public void init() {
        try {
            ...
            ThrowableHandler.getInstance().handleError(ex, GwiseMainApp.class);
        }
    }
    ...
    public void start(Stage stage) {
        ...
        try {
            Logger.getLogger(GwiseMainApp.class).info("Start the applicaiton");
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/GwiseScene.fxml"));
            ...
            ThrowableHandler.getInstance().handleWarning(ex, GwiseMainApp.class);
        } catch (Throwable th) {
            ThrowableHandler.getInstance().handleError(th, GwiseMainApp.class);
        }
    }
