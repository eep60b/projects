...
public final class ProcrunServiceIntegrationTest {
    ...
    private final String ftpsLocalTargetDirectories = "/tmp/metdata/ftps";
    ...
    public void testWithFtpsService() throws Exception {
        ...
        String[] args = new String[]{
            ...
            "-useFtpsService", "true",
            "-ftpsLocalTargetDirectories", ftpsLocalTargetDirectories};
        ...
        for (File file : sourceFiles) {
            ...
            File copiedFile = new File(ftpsLocalTargetDirectories + File.separator + file.getName() +".txt");
            if (!copiedFile.isFile()) {
                fail(file.getName() + " has NOT been copied from linux server to the dditional directory: " + ftpsLocalTargetDirectories);
                copiedFile.delete();
            }
        }
    }
     ...
     */
    @Test
    public void testWithoutFtpsService() throws Exception {
        ...
        for (File file : sourceFiles) {
            ...
            if (new File(ftpsLocalTargetDirectories + File.separator + file.getName()).isFile()) {
                fail(file.getName() + " should NOT has been copied from linux server to the dditional directory: " + ftpsLocalTargetDirectories);
            }
        }
    }
}
